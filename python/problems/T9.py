"""
T9 is a bi-objective mixed-integer convex test instance with
...
def build_model(_):
    ...
    model.f.add(expr = model.x[0] + model.x[2] + model.x[4] + model.x[6]).deactivate()
    ...
    model_parameters.U = np.array([[13,22]])
