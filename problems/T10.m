function [n,m,p,q,f,g,Df,Dg,Aineq,bineq,Aeq,beq,lb,ub,x0,is_convex,is_quadratic] = T10(~)
%T10 A non-quadratic test instance
...
% Objective function
f = @(x) [x(1)+x(3)+x(5)+exp(x(7))-1;...
          x(2)+x(4)+x(6)+x(8)];
Df = @(x) [1,0,1,0,1,0,exp(x(7)),0;0,1,0,1,0,1,0,1];
